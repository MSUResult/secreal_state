...
const PropertyDetail = () => {
  ...
  const [ownerEmail, setOwnerEmail] = useState(propertyDetail?.currentOwner?.email || '');
  useEffect(() => {
    if (user) {
  ...
  //   emailjs.sendForm(serviceId,templateId,publicKey)
            ...
            >
              ...
              <form onSubmit={handleContactOwner} ref={formRef}>
                <input
                  ...
                  name="from_email"
                  onChange={(e) => setUserEmail(e.target.value)} // Update the email dynamically
                />
                <input
                  value={username}
                  type="text"
                  ...
                  name="from_username"
                  onChange={(e) => setUsername(e.target.value)} // Update the username dynamically
                />

                {/* Make Owner's Email editable */}
                <input
                  value={ownerEmail}
                  type="email"
                  placeholder="Owner email"
                  name="to_email"
                  onChange={(e) => setOwnerEmail(e.target.value)} // Update ownerEmail state dynamically
                />
                ...
                <input
                  ...
                  placeholder="Desc"
                  name="message"
                  onChange={(e) => setDesc(e.target.value)} // Update description dynamically
                />
